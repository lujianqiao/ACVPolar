...
//  
//  Created by _.
//  Copyright © 2025/9/22 _. All rights reserved.
//
...
class ACVSignInVC: ACVBaseViewController {
    ...
    lazy var titleImageView: UIImageView = {
        let image: UIImageView = .init()
        image.image = UIImage(named: "SI_sign_in_title")
        return image
    }()
    ...
    lazy var notHaveAccountLab: UILabel = {
        ...
        lab.rz.colorfulConfer { confer in
            ...
            confer.text(" Sign up")?.textColor(.init(hex: "#8FD61B")).font(.systemFont(ofSize: 14, weight: .bold)).tapActionByLable("notHaveAccountLab")
        }
